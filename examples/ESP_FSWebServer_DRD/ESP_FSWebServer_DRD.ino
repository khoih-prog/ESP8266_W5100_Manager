/****************************************************************************************************************************
  ESP_FSWebServer_DRD - Example WebServer with SPIFFS backend for esp8266
...
void setup()
{
  ...
  Serial.print(F("\nStarting ESP_FSWebServer_DRD using "));
  ...
  //ESP8266_W5100_Manager ESP8266_W5100_manager(&webServer, &dnsServer);
  // Use this to personalize DHCP hostname (RFC952 conformed)
  ESP8266_W5100_Manager ESP8266_W5100_manager("ESP-FSWebServer_DRD");
  ...
  if (initialConfig)
  {
    ...
    //ESP8266_W5100_manager.setConfigPortalTimeout(600);
