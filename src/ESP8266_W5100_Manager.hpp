...
#ifndef ESP8266_W5100_Manager_hpp
#define ESP8266_W5100_Manager_hpp
...
#define ESP8266_W5100_MANAGER_VERSION           "ESP8266_W5100_Manager v1.0.0"

#define ESP8266_W5100_MANAGER_VERSION_MAJOR     1
#define ESP8266_W5100_MANAGER_VERSION_MINOR     0
#define ESP8266_W5100_MANAGER_VERSION_PATCH     0

#define ESP8266_W5100_MANAGER_VERSION_INT       1000000

////////////////////////////////////////////////////

#include "ESP8266_W5100_Manager_Debug.h"
...
#define USING_W5100         true

#include <SPI.h>

// You can change in sketch
#if !defined(CSPIN)
	#define CSPIN       16      // 5
#endif
...
#if ( (_ESP8266_ETH_MGR_LOGLEVEL_ > 3) && DISPLAY_STORED_CREDENTIALS_IN_CP )
...
class ESP8266_EMParameter 
{
  public:
  
    ESP8266_EMParameter(const char *custom);
    ESP8266_EMParameter(const char *id, const char *placeholder, const char *defaultValue, const int& length, 
                      const char *custom = "", const int& labelPlacement = WFM_LABEL_BEFORE);
                                           
    ESP8266_EMParameter(const EMParam_Data& EMParam_data);                      
  ...
  private:
    ...
    friend class ESP8266_W5100_Manager;
};
...
class ESP8266_W5100_Manager
{
  public:

    ESP8266_W5100_Manager(const char *iHostname = "");
...
#else
    //adds a custom parameter
    void          addParameter(ESP8266_EMParameter *p);
#endif
...
////////////////////////////////////////////////////
    ...
    ESP8266_EMParameter** getParameters();
...
#if USE_DYNAMIC_PARAMS
    int                    _max_params;
    ESP8266_EMParameter**  _params;
#else
    ESP8266_EMParameter*   _params[ETH_MANAGER_MAX_PARAMS];
#endif
...
#endif    // ESP8266_W5100_Manager_hpp
